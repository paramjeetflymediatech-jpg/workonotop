...
//             <Link href="/provider/dashboard" className="mr-4 text-gray-600 hover:text-gray-900">
//               ← Back
//             </Link>
...
//                     <p className="text-sm text-gray-600">{selectedBooking.service_name}</p>
//                   </div>
//                   <div className="flex-1 p-4">
//                     <ChatBox bookingId={selectedBooking.id} currentUserType="provider" />
//                   </div>
//                 </div>
//               ) : (
//                 <div className="flex-1 flex items-center justify-center">
//                   <p className="text-gray-500">Select a booking to start chatting</p>
//                 </div>
//               )}
//             </div>
//           </div>
