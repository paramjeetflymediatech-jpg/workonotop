...
{/* Job Details (collapsible) - Pass job as prop */}
        ...
        {!isCompleted && hasBeforePhotos && (
          <div className="bg-white rounded-2xl border border-green-300 shadow-sm p-5">
            ...
            <div className="mb-4">
              ...
              <PhotoGrid photos={photos.before} label="Before" onPhotoClick={setSelectedPhoto} />
            </div>
        ...
        {isInProgress && (
          <div className={`bg-white rounded-2xl border p-5 ${!hasAfterPhotos ? 'border-amber-300 shadow-sm' : 'border-green-200'}`}>
            ...
            {hasAfterPhotos && (
              <div className="mb-4">
                <PhotoGrid photos={photos.after} label="After" onPhotoClick={setSelectedPhoto} />
              </div>
            )}
            ...
            {photos.after.length < 10 ? (
              ...
              <p className="text-center py-4 text-sm text-gray-500 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                Maximum 10 after photos reached
              </p>
            )}
          </div>
        )}
