...
//     { label: 'Total Earned', value: `$${formatAmount(stats.totalEarnings)}`, icon: DollarSign, iconBg: 'bg-purple-100', iconColor: 'text-purple-600', href: '/provider/earnings' },
...
//     { href: '/provider/earnings', icon: DollarSign, label: 'Earnings', desc: 'Track your payouts', hoverColor: 'group-hover:text-purple-600' },
//   ];
...
//       {/* ⚠️ Stripe Not Connected Banner — dashboard me sirf banner, koi redirect nahi */}
//       {!stripeConnected && (
