...
//         // Check if already reviewed when booking is completed
...
//       if (data.success && data.data.length > 0) {
//         setHasReviewed(true)
//         console.log('Review exists:', data.data[0])
//       } else {
...
//   console.log('Should show review:', booking.status === 'completed' && !hasReviewed)
...
//                         </p>
//                         {/* notes are intentionally omitted from customer view; may include commission/internal details */}
//                         <p className="text-xs text-gray-400 mt-1">
