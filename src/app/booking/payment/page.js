...
//                               If job takes longer, you'll be charged <span className="font-bold">${hourlyRate.toFixed(2)}/hour</span> for extra time. You'll approve before any overtime is worked.
//                             </p>
//                           </div>
//                         </div>
//                       </div>
...
//                     Your card will be authorized for up to ${(basePrice + (hourlyRate * 2)).toFixed(2)} to cover potential overtime. You'll only be charged for actual time worked.
//                   </p>
//                 </div>
//               </div>
