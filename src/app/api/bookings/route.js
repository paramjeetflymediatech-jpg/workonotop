...
//     // Initial total is just base price (additional added at billing)
...
//           commission_percent, provider_amount, status)
//          VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NULL,?,  'pending')`,
//         [
//           bookingNumber, user_id || null, service_id, service_name || null,
//           service_price, additional_price || 0, // Store for later overtime calculation
//           first_name, last_name, email, phone,
