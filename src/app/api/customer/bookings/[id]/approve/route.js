...
//       const totalAmount = parseFloat(booking.service_price)
//       const providerAmount = parseFloat(booking.final_provider_amount || booking.provider_amount || 0)
//       const commissionAmount = totalAmount - providerAmount
      
//       const totalCents = Math.round(totalAmount * 100)
//       const providerCents = Math.round(providerAmount * 100)
      
//       // Get provider's Stripe account from service_providers table
...
//         stripe_account: providerStripeAccountId || 'none'
//       })
...
//         if (hasProviderAccount && providerStripeAccountId) {
//           try {
...
//               [id, `💰 £${providerAmount} sent to ${booking.provider_name}`]
//             )
...
//               [id, `⚠️ MANUAL: Pay ${booking.provider_name} £${providerAmount}`]
//             )
//           }
//         } else {
//           await connection.execute(
//             `INSERT INTO booking_status_history (booking_id, status, notes) VALUES (?, 'payment_pending', ?)`,
//             [id, `💰 Pay ${booking.provider_name} £${providerAmount} manually`]
//           )
//         }
...
//           [id, `✅ Customer approved. Provider gets £${providerAmount}`]
//         )
...
//           success: true,
//           message: hasProviderAccount 
//             ? `Payment sent to ${booking.provider_name}`
//             : `Completed. Pay ${booking.provider_name} £${providerAmount} manually`,
//           data: {
