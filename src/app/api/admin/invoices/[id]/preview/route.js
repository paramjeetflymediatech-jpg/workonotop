// app/api/admin/invoices/[id]/preview/route.js - LUXURY REFINED DESIGN
          ...
          <div class="card-body">
            ...
            <div class="customer-row">
              <div>
                ...
                <div class="contact-chips">
                  <span class="chip"><span class="dot"></span>${booking.customer_email || ''}</span>
                  <span class="chip"><span class="dot"></span>${booking.customer_phone || ''}</span>
                  <span class="chip"><span class="dot"></span>${booking.address_line1 || ''} ${booking.city || ''}</span>
                </div>
              </div>
            </div>
            ...
            <div class="footer">
              <div class="footer-left">
                ...
                Invoice #${invoice.invoice_number} &bull; Thank you for choosing WorkOnTap
              </div>
