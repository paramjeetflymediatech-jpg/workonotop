...
//   const verificationUrl = `${process.env.NEXT_PUBLIC_APP_URL}/provider/verify-email?token=${token}`;
...
//   const reapplyUrl = `${process.env.NEXT_PUBLIC_APP_URL}/provider/register`;
